...
# Configs
COST_GRID_PATH = "../scripts/data/processed/cost_grid.npy"
ELEVATION_TIF = "../scripts/data/raw/elevation.tif"
DELIVERY_PATH = "../scripts/data/raw/delivery_coords.json"
HUB_PATH = "../scripts/data/raw/central_hub.json"
# DataExpert\capstone_drone\scripts\data\processed\cost_grid.npy

def load_barn():
    with open("../scripts/data/raw/barn.json") as f:
